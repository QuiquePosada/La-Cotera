                                    ...
                                    {/* <Fade style={paper} triggerOnce direction="left" delay={500}> */}
                                        <Paper style={paper}>
                                            ...
                                            <div style={{margin: '0 15px'}}>
                                                ...
                                                <p>
                                                    We have <strong><u>{(new Date().getFullYear()) - (new Date("01/12/2006").getFullYear())} years</u></strong>
                                                    &nbsp;being the best breeder in Mexico
                                                </p>
                ...
                <Section title={data.markdown.frontmatter.contact_info.title} subtitle={data.markdown.frontmatter.contact_info.subtitle} description={data.markdown.frontmatter.contact_info.description}>
                    ...
                    <Grid container>
                        <Grid item xs={12} sm={6}>
                            <form method="post" netlify-honeypot="bot-field" data-netlify="true" name="contact" style={{display: 'flex', flexDirection: 'column'}}>
