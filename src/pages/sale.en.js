    ...
    return (
        <Layout pageContext={pageContext} >
            ...
            {/* Content */}
            {
                ...
                :
                <Section subtitle="We currently have no cattle on sale" title="We invite you to be on the lookout, or to contact us to receive more information">
...
export const query = graphql`
    {
        data: allContentfulVaca(
            filter: {node_locale: {eq: "en-US"}, onSale: {eq: true}}
        ...
        markdown: markdownRemark(frontmatter: {lang: {eq: "en"}, templateKey: {eq: "sale"}}) {
            frontmatter {
                title
                subtitle
                section_1 {
